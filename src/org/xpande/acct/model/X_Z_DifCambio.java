...
public class X_Z_DifCambio extends PO implements I_Z_DifCambio, I_Persistent 
{
...
// @#Date@
    ...
    /** Load Constructor */
    public X_Z_DifCambio (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_DifCambio[")
	...
	{
		if (Z_DifCambio_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_DifCambio_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_DifCambio_ID, Integer.valueOf(Z_DifCambio_ID));
	}
