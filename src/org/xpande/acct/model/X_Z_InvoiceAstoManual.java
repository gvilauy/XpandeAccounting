...
/** Generated Model for Z_InvoiceAstoManual
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_InvoiceAstoManual extends PO implements I_Z_InvoiceAstoManual, I_Persistent 
{
...
// @CurrencyRate@;1
			setZ_InvoiceAstoManual_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_InvoiceAstoManual (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_InvoiceAstoManual[")
	...
	/** Set Z_InvoiceAstoManual ID.
		@param Z_InvoiceAstoManual_ID Z_InvoiceAstoManual ID	  */
	public void setZ_InvoiceAstoManual_ID (int Z_InvoiceAstoManual_ID)
	{
		if (Z_InvoiceAstoManual_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_InvoiceAstoManual_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_InvoiceAstoManual_ID, Integer.valueOf(Z_InvoiceAstoManual_ID));
	}

	/** Get Z_InvoiceAstoManual ID.
		@return Z_InvoiceAstoManual ID	  */
