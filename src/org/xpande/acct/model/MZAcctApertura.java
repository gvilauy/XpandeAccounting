...
public class MZAcctApertura extends X_Z_AcctApertura implements DocAction, DocOptions {
    ...
    public MZAcctApertura (Properties ctx, int Z_AcctApertura_ID, String trxName)
    {
      super (ctx, Z_AcctApertura_ID, trxName);
    }

    /** Load Constructor */
    public MZAcctApertura (Properties ctx, ResultSet rs, String trxName)
    {
