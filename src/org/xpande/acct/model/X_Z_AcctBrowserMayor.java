...
/** Generated Model for Z_AcctBrowserMayor
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_AcctBrowserMayor extends PO implements I_Z_AcctBrowserMayor, I_Persistent 
{
    ...
    {
      super (ctx, Z_AcctBrowserMayor_ID, trxName);
      /** if (Z_AcctBrowserMayor_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_Z_AcctBrowserMayor (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_AcctBrowserMayor[")
	...
	/** Set Z_AcctBrowserMayor ID.
		@param Z_AcctBrowserMayor_ID Z_AcctBrowserMayor ID	  */
	public void setZ_AcctBrowserMayor_ID (int Z_AcctBrowserMayor_ID)
	{
		if (Z_AcctBrowserMayor_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_AcctBrowserMayor_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_AcctBrowserMayor_ID, Integer.valueOf(Z_AcctBrowserMayor_ID));
	}

	/** Get Z_AcctBrowserMayor ID.
		@return Z_AcctBrowserMayor ID	  */
