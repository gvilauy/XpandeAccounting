...
public class X_Z_LoadJournal extends PO implements I_Z_LoadJournal, I_Persistent 
{
    ...
    public X_Z_LoadJournal (Properties ctx, int Z_LoadJournal_ID, String trxName)
    {
      super (ctx, Z_LoadJournal_ID, trxName);
      /** if (Z_LoadJournal_ID == 0)
        {
...
// N
			setProcessing (false);
// N
			setZ_LoadJournal_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_LoadJournal (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadJournal[")
	...
	public void setZ_LoadJournal_ID (int Z_LoadJournal_ID)
	{
		if (Z_LoadJournal_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadJournal_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadJournal_ID, Integer.valueOf(Z_LoadJournal_ID));
	}
