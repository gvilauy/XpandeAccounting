...
/** Generated Model for Z_LoadJournalFile
 *  @author Adempiere (generated) 
 *  @version Release 3.9.0 - $Id$ */
public class X_Z_LoadJournalFile extends PO implements I_Z_LoadJournalFile, I_Persistent 
{
...
// N
			setProcessed (false);
// N
			setZ_LoadJournalFile_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_LoadJournalFile (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadJournalFile[")
	...
	{
		set_Value (COLUMNNAME_CodigoCCosto, CodigoCCosto);
	}

	/** Get CodigoCCosto.
		@return Codigo de centro de costo
	  */
	public String getCodigoCCosto () 
	{
		return (String)get_Value(COLUMNNAME_CodigoCCosto);
	}
	...
	/** Set FechaAcctCadena.
		@param FechaAcctCadena 
		Fecha contable en formato string
	  */
	public void setFechaAcctCadena (String FechaAcctCadena)
	{
		set_Value (COLUMNNAME_FechaAcctCadena, FechaAcctCadena);
	}

	/** Get FechaAcctCadena.
		@return Fecha contable en formato string
	  */
	public String getFechaAcctCadena () 
	{
		return (String)get_Value(COLUMNNAME_FechaAcctCadena);
	}
	...
	/** Set Z_LoadJournalFile ID.
		@param Z_LoadJournalFile_ID Z_LoadJournalFile ID	  */
	public void setZ_LoadJournalFile_ID (int Z_LoadJournalFile_ID)
	{
		if (Z_LoadJournalFile_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadJournalFile_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadJournalFile_ID, Integer.valueOf(Z_LoadJournalFile_ID));
	}

	/** Get Z_LoadJournalFile ID.
		@return Z_LoadJournalFile ID	  */
	public int getZ_LoadJournalFile_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_LoadJournalFile_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
    ...
    {
		return (I_Z_LoadJournal)MTable.get(getCtx(), I_Z_LoadJournal.Table_Name)
			.getPO(getZ_LoadJournal_ID(), get_TrxName());	}

	/** Set Z_LoadJournal ID.
		@param Z_LoadJournal_ID Z_LoadJournal ID	  */
	public void setZ_LoadJournal_ID (int Z_LoadJournal_ID)
	{
		if (Z_LoadJournal_ID < 1) 
			set_Value (COLUMNNAME_Z_LoadJournal_ID, null);
		else 
			set_Value (COLUMNNAME_Z_LoadJournal_ID, Integer.valueOf(Z_LoadJournal_ID));
	}

	/** Get Z_LoadJournal ID.
		@return Z_LoadJournal ID	  */
